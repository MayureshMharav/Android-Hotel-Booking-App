...
public class Karls_Hotel extends AppCompatActivity {
ImageButton btnback_karls , btnhome_karls;
Button single_bed,double_bed,pool,lux;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_karls_hotel);

        Intent intent=getIntent();

        btnback_karls=findViewById(R.id.karls_back_btn);
        btnhome_karls=findViewById(R.id.karls_home_btn);

        btnback_karls.setOnClickListener(v -> {
            finish();
        });

        btnhome_karls.setOnClickListener(v -> {
            Intent btnhome_karls = new Intent(Karls_Hotel.this, Guest_Home.class);

            // prevents duplicate Home pages
            btnhome_karls.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);

            startActivity(btnhome_karls);
        });
        ...
        single_bed.setOnClickListener(v -> {
            ...
            Dialog dialog_single_bed = new Dialog(Karls_Hotel.this);
            ...
            BookRoom_single.setOnClickListener(view -> {
                ...
                Intent bk_int = new Intent(Karls_Hotel.this, MyInvoice.class);
        ...
        double_bed.setOnClickListener(v -> {
            ...
            Dialog dialog_double_bed = new Dialog(Karls_Hotel.this);
        ...
        pool.setOnClickListener(v -> {
            ...
            Dialog dialog_pool_bed = new Dialog(Karls_Hotel.this);
        ...
        lux.setOnClickListener(v -> {
            ...
            Dialog dialog_luxury_details = new Dialog(Karls_Hotel.this);
