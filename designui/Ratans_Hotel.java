...
public class Ratans_Hotel extends AppCompatActivity {
ImageButton btnback_ratans, btnhome_ratans;
Button single_bed,double_bed,pool,lux;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ratans_hotel);

        Intent intent = getIntent();

        btnback_ratans = findViewById(R.id.ratans_back_btn);
        btnhome_ratans = findViewById(R.id.ratans_home_btn);

        btnback_ratans.setOnClickListener(v -> {
            finish();
        });

        btnhome_ratans.setOnClickListener(v -> {
            Intent btnhome_ratans = new Intent(Ratans_Hotel.this, Guest_Home.class);

            // prevents duplicate Home pages
            btnhome_ratans.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);

            startActivity(btnhome_ratans);
        });
        //Dialog Single bed
        single_bed=findViewById(R.id.single_bed_btn);
        single_bed.setOnClickListener(v -> {

            Dialog dialog_single_bed = new Dialog(Ratans_Hotel.this);
            ...
            BookRoom_single.setOnClickListener(view -> {
                ...
                Intent bk_int = new Intent(Ratans_Hotel.this, MyInvoice.class);
        ...
        double_bed.setOnClickListener(v -> {
            ...
            Dialog dialog_double_bed = new Dialog(Ratans_Hotel.this);
        ...
        pool.setOnClickListener(v -> {
            ...
            Dialog dialog_pool_bed = new Dialog(Ratans_Hotel.this);
        ...
        lux.setOnClickListener(v -> {
            ...
            Dialog dialog_luxury_details = new Dialog(Ratans_Hotel.this);
