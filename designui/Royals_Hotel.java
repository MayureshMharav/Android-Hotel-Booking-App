...
public class Royals_Hotel extends AppCompatActivity {
ImageButton btnback_royals, btnhome_royals;
Button single_bed,double_bed,pool,lux;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_royals_hotel);

        Intent intent = getIntent();

        btnback_royals = findViewById(R.id.royals_back_btn);
        btnhome_royals = findViewById(R.id.royals_home_btn);

        btnback_royals.setOnClickListener(v -> {
            finish();
        });

        btnhome_royals.setOnClickListener(v -> {
            Intent btnhome_royals = new Intent(Royals_Hotel.this, Guest_Home.class);

            // prevents duplicate Home pages
            btnhome_royals.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);

            startActivity(btnhome_royals);
        });
        ...
        single_bed.setOnClickListener(v -> {
            ...
            Dialog dialog_single_bed = new Dialog(Royals_Hotel.this);
            ...
            BookRoom_single.setOnClickListener(view -> {
                ...
                Intent bk_int = new Intent(Royals_Hotel.this, MyInvoice.class);
        ...
        double_bed.setOnClickListener(v -> {
            ...
            Dialog dialog_double_bed = new Dialog(Royals_Hotel.this);
        ...
        pool.setOnClickListener(v -> {
            ...
            Dialog dialog_pool_bed = new Dialog(Royals_Hotel.this);
        ...
        lux.setOnClickListener(v -> {
            ...
            Dialog dialog_luxury_details = new Dialog(Royals_Hotel.this);
